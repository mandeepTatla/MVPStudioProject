...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
         //   url: 'http://localhost:60290/profile/profile/getEmployerProfile',
            url: 'https://talentservicesprofile01.azurewebsites.net/profile/profile/getEmployerProfile',
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentservicesprofile01.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
